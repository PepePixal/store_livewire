<div>
    <form wire:submit='store' class="space-y-4 max-w-2xl p-4 bg-surface-alt dark:bg-surface-dark-alt rounded-lg shadow-md">
        ...
        <!-- llamadas al componente input.blade.php, enviando la iformación para cada input  -->
        <x-form.input label="Name" name="name" placeholder="Enter your name" />
        <x-form.input label="Stock" name="stock" placeholder="Enter the product stock"/>
        <x-form.input label="Price" name="price" placeholder="Enter the product price"/>
